        ...
        <div className="pt-4">
          ...
          <div className="space-y-3">
            ...
            {cargando && notas.length === 0 && (
              <p className="text-xs font-medium text-gray-400 animate-pulse text-center py-4">Conectando con Supabase...</p>
            )}

            {!cargando && notas.length === 0 && (
              <p className="text-xs font-medium text-gray-400 text-center py-4">No hay notas guardadas aún en la base de datos.</p>
            )}
